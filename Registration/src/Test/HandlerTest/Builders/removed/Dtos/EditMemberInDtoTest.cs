...
namespace HandlersTest.Builders.removed.Dtos;
...
public class EditMemberInDtoTest
{
    public static EditMemberInDto ValidObjectOne() =>
        new EditMemberInDto()
        {
            MemberId = MemberTest.ValidObjectOne().Id,
            ChurchName = "Sara Nossa Terra",
            LastPost = PostTest.ValidObjectOne().Name!,
            LetterReceiver = "COM CARTA"
        };
    public static EditMemberInDto ValidObjectTwo() =>
    new EditMemberInDto()
    {
        MemberId = MemberTest.ValidObjectOne().Id,
        ChurchName = "Quadrangular",
        LastPost = PostTest.ValidObjectOne().Name!,
        LetterReceiver = "COM CARTA"
    };
