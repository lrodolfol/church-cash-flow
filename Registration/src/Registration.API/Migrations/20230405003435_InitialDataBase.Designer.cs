...
namespace Registration.API.Migrations
{
    ...
    [Migration("20230405003435_InitialDataBase")]
            ...
            modelBuilder.Entity("Registration.DomainBase.Entities.OutFlow", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Authorized = true,
                            ChurchId = 1,
                            Day = new DateTime(2023, 4, 5, 0, 34, 35, 29, DateTimeKind.Utc).AddTicks(3132),
                            Discount = 0m,
                            Interest = 2m,
                            MonthYear = "04/2023",
                            OutFlowKindId = 1,
                        ...
                        new
                        {
                            ...
                            Authorized = true,
                            ChurchId = 2,
                            Day = new DateTime(2023, 4, 5, 0, 34, 35, 29, DateTimeKind.Utc).AddTicks(3262),
                            Discount = 0m,
                            Interest = 1.56m,
                            MonthYear = "04/2023",
                            OutFlowKindId = 2,
                        ...
                        new
                        {
                            ...
                            Authorized = true,
                            ChurchId = 3,
                            Day = new DateTime(2023, 4, 5, 0, 34, 35, 29, DateTimeKind.Utc).AddTicks(3274),
                            Discount = 20m,
                            Interest = 0.6m,
                            MonthYear = "04/2023",
                            OutFlowKindId = 3,
            ...
            modelBuilder.Entity("Registration.DomainBase.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PassWord = "12345678",
                            PasswordHash = "10000.vuSdvDqLtKgeVyDEcn9l6A==.aI236VpayiBE+vw/mgY0XCmSDmrPk6ITvELQfU+qZnw=",
                            RoleId = 1
                        },
                        new
                        {
                            ...
                            PassWord = "12345678",
                            PasswordHash = "10000.uNxbFFW9IWeD/63E/og6SA==.RSCEiaedPwSzgPJYDyf4z96M4lI/3JjvhYtfbcjQw0o=",
                            RoleId = 2
                        });
                });
