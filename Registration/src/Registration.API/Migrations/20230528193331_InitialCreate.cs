    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "SLC-DD16D8", new DateTime(2023, 5, 28, 16, 33, 30, 927, DateTimeKind.Local).AddTicks(8137), "Rodolfo de Jesus Silva", 2 },
                    { 2, 2, "SLC-A0714F", new DateTime(2023, 5, 28, 16, 33, 30, 927, DateTimeKind.Local).AddTicks(8200), "Kelly Cristina Martins", 3 },
                    { 3, 1, "SLC-973860", new DateTime(2023, 5, 28, 16, 33, 30, 927, DateTimeKind.Local).AddTicks(8205), "Manuela Martins de Jesus", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 25, 4, 1, "2023/05", new DateTime(2023, 5, 28, 16, 33, 30, 929, DateTimeKind.Local).AddTicks(3267), "oferta do irmao / irma", 1, null, 1, "Pr Antônio Cristino Alves", 55.90m },
                    { 2, 25, 4, 2, "2023/05", new DateTime(2023, 5, 28, 16, 33, 30, 929, DateTimeKind.Local).AddTicks(3283), "oferta do irmao / irma", 2, null, 2, "Obª Kelly Cristina Martins", 326.05m },
                    { 3, 25, 4, 1, "2023/05", new DateTime(2023, 5, 28, 16, 33, 30, 929, DateTimeKind.Local).AddTicks(3284), "oferta do irmao / irma", 3, null, 3, "Dcª Iolanda da Silva Souza", 12.80m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 100m, 1ul, 1, "05/2023", new DateTime(2023, 5, 28, 19, 33, 30, 928, DateTimeKind.Utc).AddTicks(8446), "Saida de caixa 1", 2m, 1, 0m },
                    { 2, 1000.01m, 1ul, 2, "05/2023", new DateTime(2023, 5, 28, 19, 33, 30, 928, DateTimeKind.Utc).AddTicks(8520), "Saida de caixa 2", 1.56m, 2, 0m }
                });

            migrationBuilder.InsertData(
                table: "OutFlow",
                columns: new[] { "Id", "Amount", "Authorized", "ChurchId", "Competence", "Day", "Description", "Discount", "Interest", "OutFlowKindId", "TotalAmount" },
                values: new object[] { 3, 1500.56m, 1ul, 3, "05/2023", new DateTime(2023, 5, 28, 19, 33, 30, 928, DateTimeKind.Utc).AddTicks(8525), "Saida de caixa 3", 20m, 0.6m, 3, 0m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "5B9FA8", "Rodolfo de Jesus Silva", "12345678", "10000.uNEBQtYWUUyoni5hl/coHA==.Va/aMKsknil71OIEo60qN9lAh7vvdwhi6sWbbSxypXc=", 1 },
                    { 2, 2, "9C1EEB", "Kelly Cristina Martins", "12345678", "10000.J+2z6Vy7tj6JbJgvxTOy1Q==.66USq+GhOp3LHS7Yucq0FZsC7vUYLkLtNz3cbsz4fNI=", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "04/2023", new DateTime(2023, 5, 28, 16, 33, 30, 930, DateTimeKind.Local).AddTicks(1374), "Primicias do irmao/irma", 1, 1, 56.60m },
                    { 2, 2, "03 /2023", new DateTime(2023, 5, 28, 16, 33, 30, 930, DateTimeKind.Local).AddTicks(1386), "Primicias do irmao / irma", 2, 2, 565.60m },
                    { 3, 1, "02/2023", new DateTime(2023, 5, 28, 16, 33, 30, 930, DateTimeKind.Local).AddTicks(1387), "Primicias do irmao / irma", 2, 2, 156.60m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "04/2023", new DateTime(2023, 5, 28, 16, 33, 30, 929, DateTimeKind.Local).AddTicks(6918), "dizimo do irmao / irma", 1, 1, 33.45m },
                    { 2, 2, "03/2023", new DateTime(2023, 5, 28, 16, 33, 30, 929, DateTimeKind.Local).AddTicks(6931), "dizimo do irmao / irma", 2, 1, 533.45m },
                    { 3, 1, "02/2023", new DateTime(2023, 5, 28, 16, 33, 30, 929, DateTimeKind.Local).AddTicks(6933), "dizimo do irmao / irma", 1, 2, 33.45m }
                });
