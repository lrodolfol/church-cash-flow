        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstTreasurerId = table.Column<int>(type: "int", nullable: false),
                    SecondTreasurerId = table.Column<int>(type: "int", nullable: false),
                    FirstSecretaryId = table.Column<int>(type: "int", nullable: false),
                    SecondSecretaryId = table.Column<int>(type: "int", nullable: false),
                    FirstPastorId = table.Column<int>(type: "int", nullable: false),
                    SecondPastorId = table.Column<int>(type: "int", nullable: false),
                    FirstTreasurerId1 = table.Column<int>(type: "int", nullable: true),
                    SecondTreasurerId1 = table.Column<int>(type: "int", nullable: true),
                    FirstSecretaryId1 = table.Column<int>(type: "int", nullable: true),
                    SecondSecretaryId1 = table.Column<int>(type: "int", nullable: true),
                    FirstPastorId1 = table.Column<int>(type: "int", nullable: true),
                    SecondPastorId1 = table.Column<int>(type: "int", nullable: true),
                    Active = table.Column<ulong>(type: "BIT", nullable: false, defaultValue: 1ul)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Church",
                columns: new[] { "Id", "Acronym", "AddressId", "FirstPastorId", "FirstPastorId1", "FirstSecretaryId", "FirstSecretaryId1", "FirstTreasurerId", "FirstTreasurerId1", "Name", "SecondPastorId", "SecondPastorId1", "SecondSecretaryId", "SecondSecretaryId1", "SecondTreasurerId", "SecondTreasurerId1" },
                values: new object[,]
                {
                    { 1, "SLC", 1, 1, null, 1, null, 1, null, "CEO São Lourenço", 2, null, 2, null, 2, null },
                    { 2, "CRT", 2, 1, null, 1, null, 1, null, "CEP Cristina", 2, null, 2, null, 2, null },
                    { 3, "LBR", 3, 1, null, 1, null, 1, null, "CEP Lambari", 2, null, 2, null, 2, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "SLC-E7F69E", new DateTime(2023, 6, 8, 11, 8, 29, 523, DateTimeKind.Local).AddTicks(6468), new DateTime(2003, 6, 8, 11, 8, 29, 523, DateTimeKind.Local).AddTicks(6441), "Rodolfo de Jesus Silva", null, 2 },
                    { 2, 2, "SLC-89B281", new DateTime(2023, 6, 8, 11, 8, 29, 523, DateTimeKind.Local).AddTicks(6540), new DateTime(1999, 6, 8, 11, 8, 29, 523, DateTimeKind.Local).AddTicks(6539), "Kelly Cristina Martins", null, 3 },
                    { 3, 1, "SLC-E602A6", new DateTime(2023, 6, 8, 11, 8, 29, 523, DateTimeKind.Local).AddTicks(6552), new DateTime(2005, 6, 8, 11, 8, 29, 523, DateTimeKind.Local).AddTicks(6552), "Manuela Martins de Jesus", null, 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 25, 4, 1, "2023/05", new DateTime(2023, 6, 8, 11, 8, 29, 528, DateTimeKind.Local).AddTicks(3596), "oferta do irmao / irma", 1, null, 1, "Pr Antônio Cristino Alves", 55.90m },
                    { 2, 25, 4, 2, "2023/05", new DateTime(2023, 6, 8, 11, 8, 29, 528, DateTimeKind.Local).AddTicks(3630), "oferta do irmao / irma", 2, null, 2, "Obª Kelly Cristina Martins", 326.05m },
                    { 3, 25, 4, 1, "2023/05", new DateTime(2023, 6, 8, 11, 8, 29, 528, DateTimeKind.Local).AddTicks(3632), "oferta do irmao / irma", 3, null, 3, "Dcª Iolanda da Silva Souza", 12.80m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 100m, 1ul, 1, "06/2023", new DateTime(2023, 6, 8, 14, 8, 29, 527, DateTimeKind.Utc).AddTicks(2301), "Saida de caixa 1", 2m, 1, 0m },
                    { 2, 1000.01m, 1ul, 2, "06/2023", new DateTime(2023, 6, 8, 14, 8, 29, 527, DateTimeKind.Utc).AddTicks(2779), "Saida de caixa 2", 1.56m, 2, 0m }
                });

            migrationBuilder.InsertData(
                table: "OutFlow",
                columns: new[] { "Id", "Amount", "Authorized", "ChurchId", "Competence", "Day", "Description", "Discount", "Interest", "OutFlowKindId", "TotalAmount" },
                values: new object[] { 3, 1500.56m, 1ul, 3, "06/2023", new DateTime(2023, 6, 8, 14, 8, 29, 527, DateTimeKind.Utc).AddTicks(2793), "Saida de caixa 3", 20m, 0.6m, 3, 0m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "9C37C5", "Rodolfo de Jesus Silva", "12345678", "10000.4+XrGHGrZ3196FOPjpEn0Q==.4BCR6BV8Fma9Iwbqk0Dm+mvmQdab5QrpXmJO22M7Tvc=", 1 },
                    { 2, 2, "DF872E", "Kelly Cristina Martins", "12345678", "10000.8twBoAD14a2pFt/isAyi9Q==.s6dkflPUEAXsJU265su3KJl8gtqzWgGVXQsjvBOWwOs=", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "04/2023", new DateTime(2023, 6, 8, 11, 8, 29, 529, DateTimeKind.Local).AddTicks(8294), "Primicias do irmao/irma", 1, 1, 56.60m },
                    { 2, 2, "03 /2023", new DateTime(2023, 6, 8, 11, 8, 29, 529, DateTimeKind.Local).AddTicks(8315), "Primicias do irmao / irma", 2, 2, 565.60m },
                    { 3, 1, "02/2023", new DateTime(2023, 6, 8, 11, 8, 29, 529, DateTimeKind.Local).AddTicks(8317), "Primicias do irmao / irma", 2, 2, 156.60m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "04/2023", new DateTime(2023, 6, 8, 11, 8, 29, 529, DateTimeKind.Local).AddTicks(830), "dizimo do irmao / irma", 1, 1, 33.45m },
                    { 2, 2, "03/2023", new DateTime(2023, 6, 8, 11, 8, 29, 529, DateTimeKind.Local).AddTicks(857), "dizimo do irmao / irma", 2, 1, 533.45m },
                    { 3, 1, "02/2023", new DateTime(2023, 6, 8, 11, 8, 29, 529, DateTimeKind.Local).AddTicks(859), "dizimo do irmao / irma", 1, 2, 33.45m }
                });
